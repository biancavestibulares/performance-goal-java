...
public class Cores {
	//Fazendo uso da biblioteca de cores do console
	//MATERIAL RETIRADO DE https://github.com/conteudoGeneration/cookbook_java_fullstack/blob/main/01_java/pr02.md
	
	//TEXT_RESET é usado para redefinir todos os atributos de estilo de texto para o padrão
	public static final String TEXT_RESET = "\u001B[0m";

	//TEXT_COLOR é usado para definir a cor do texto
	...
	//TEXT_COLOR_BOLD é usado para definir a cor do texto com um estilo em negrito 
	...
	//TEXT_COLOR_UNDERLINE é usado para definir a cor do texto com um estilo sublinhado
	...
	//TEXT_COLOR_BRIGHT é usado para definir a cor do texto com intensidade alta
	...
	//TEXT_COLOR_BOLD_BRIGHT é usado para definir a cor do texto com um estilo em negrito e intensidade alta
	...
	//ANSI_COLOR_BACKGROUND é usado para definir a cor de fundo do texto
	...
	//ANSI_COLOR_BACKGROUND_BRIGHT é usado para definir a cor de fundo do texto com intensidade alta
